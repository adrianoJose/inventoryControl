...
?> 
    ...
    <form class="form-horizontal" id="add-contato" name="add_frm" action="php/codigos/Atualizar.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group afastamento-prod">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" id="txtCodigo" placeholder="Descrição" id="descricao" class="form-control" name="txt_descricao" value="<?php echo $value->nome_Produto; ?>" required>
            </div>
          </div>
          <div class="form-group afastamento-prod">
            <label for="txtPreco" class="col-sm-3 control-label">Preço unitário: </label>
            <div class="col-sm-9">
              <input type="double" class="form-control" id="txtCodigo" placeholder="Preço unitário" id="preco" class="form-control" name="txt_preco" value="<?php echo $value->preco_Unitario; ?>" required>
            </div>
          </div>
          <div class="form-group afastamento-prod">
            <label for="quantidade" class="col-sm-3 control-label">Quantidade </label>
            <div class="col-sm-9">
              <input type="number" class="form-control" id="txtCodigo" placeholder="Quantidade" id="quantidade" class="form-control" name="txt_quantidade" value="<?php echo $value->quantidade_Produto; ?>" required>
            </div>
          </div>
          <div class="form-group afastamento-prod">
            ...
            <div class="col-sm-9">
                <select id="categoria" class="form-control" name="slc_categoria" required>
                    ...
                    <?php include_once 'view/produto/select-categoria.php'; ?>
                </select>
            </div>
          </div>
          <div class="form-group afastamento-prod">
            <label for="data" class="col-sm-3 control-label">Data de Cadastro </label>
            <div class="col-sm-9">
                <input type="hidden" name='txt_data' value="<?php echo $value->data_Cadastro; ?>" />
                <input type="date" class="form-control" id="txtCodigo" placeholder="Preço unitário" id="data" class="form-control" name="" value="<?php echo $value->data_Cadastro; ?>" disabled>
            </div>
          </div>
